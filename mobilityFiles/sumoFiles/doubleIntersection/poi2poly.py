...
def convert_poi_rsu(fname):
    ...
    for i, child in enumerate(root):
        ...
        # print("{},{},15;".format(y-12, x))
        print("{},{},15;".format(y, x+12))

def convert_rsu_poly(fname,  outfile="add.poly.xml"):
    """
    Expected in format x,y,height
    """
    f1 = open(fname, "r")
    f2 = open(outfile, "w")
    for i,line in enumerate(f1.readlines()):
        ...
        r = 1
        c = 100
        setCircle(idx, x, y, r, c, prefix, type, color, fill, layer, f2)
...
if __name__ == "__main__":
    ...
    convert_rsu_poly(args.filename)